...
DATA_DIR = '/home/josip/Documents/DU/LAB2/fer-deep-learning/lab2/datasets/MNIST/'
SAVE_DIR = "/home/josip/Documents/DU/LAB2/fer-deep-learning/lab2/out/"
...
train_x = dataset.train.images.reshape([-1, 1, 28, 28])
train_y = dataset.train.labels

valid_x = dataset.validation.images.reshape([-1, 1, 28, 28])
valid_y = dataset.validation.labels

test_x = dataset.test.images.reshape([-1, 1, 28, 28])
